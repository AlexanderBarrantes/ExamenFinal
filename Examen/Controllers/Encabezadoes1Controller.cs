...
{
    public class Encabezadoes1Controller : Controller
    {
        ...
        // GET: Encabezadoes1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Encabezadoes1/Create
